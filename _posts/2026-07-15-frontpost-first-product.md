...
正如我在 [FrontPost 设计规范](https://design.frontpost.net/) 里写下的：**前沿知识，平等可达。** 知识平权不是一句很轻的口号，而是长期工程。即便有了 LLM，不同地区、语言、设备、教育背景和机构资源之间的 accessibility 也不会自动变平。学生、开发者、行业从业者，或者只是对某件事好奇的人，都可能被英语、订阅、圈子和工具熟悉度挡在外面。FrontPost 现在当然做不到真正抹平这些差异，但它会一直决定 FrontPost 往哪里走。
