...
正如我在 [FrontPost 设计规范](https://design.frontpost.net/) 里写下的：**前沿知识，平等可达。** 这里面也有一种很朴素的知识平权：一个人能否及时理解前沿，不该过度取决于英语水平、所在地区、机构订阅，或者是否熟悉复杂的信息工具。我希望 FrontPost 保持足够 affordable 的定价，通过跨语言的信息组织与清楚的来源，帮助更多人，尤其是来自非英语国家和地区的人获得高质量的信息与判断支持，尽量抹平这些本不该成为门槛的信息差。这未必是现阶段就能实现的目标，但会是 FrontPost 长期的核心愿景。
