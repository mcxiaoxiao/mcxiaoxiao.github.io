...
正如我在 [FrontPost 设计规范](https://design.frontpost.net/) 里写下的：**前沿知识，平等可达。** 我希望它保持足够 affordable 的定价，也能帮助来自不同非英语国家和地区、同样想了解前沿的人获得高质量的信息与判断支持。这未必是现阶段就能实现的目标，但会是 FrontPost 长期的核心愿景。
