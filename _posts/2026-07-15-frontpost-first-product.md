...
后来到了现代报业，报纸又从官方公告变成了大众日常。比如 1896 年创刊的 Daily Mail，它的重要之处在于把报纸做得更便宜、更短、更适合普通人的日常节奏。[^3] 半便士、简洁、面向更广泛的人群，这背后其实是一个产品判断：信息要以一种可持续消费的方式抵达人。
...
玻尔已经覆盖论文追踪、每日推送、精读、调研和综述；[^8] Perplexity 也有完整的 deep research。FrontPost 的 MVP 聚焦发现、泛读和送达，细读与归档继续使用原文或现有工具。
...
第一版范围：
  ...
  - 让用户写下一组具体的关注方向。
  - 每天或每周稳定抓取、去重和筛选新增内容。
  - 用一个 Web 阅读页和一种投递方式生成邮报，每条内容可以回到来源。
  - 记录收藏、跳过和反馈，用于调整下一期。

先看内容相关度、阅读时间和连续打开情况，再决定增加跨端、TTS、Zotero、更多数据库，或者继续改进筛选。

FrontPost 希望以 AI-Native 的高效协作方式，做一个能够持续高效迭代的 AI-Native 产品。
