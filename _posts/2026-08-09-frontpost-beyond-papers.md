...
我后来又想了一步：**研究不只存在于论文里。** 论文是一种重要的交流形式，代码、数据、实验日志、博客、论坛、比赛和社区协作同样会留下研究过程。评价体系还催生了不少二级问题：怎样包装更像创新，榜单高零点几能不能再发一篇，什么故事更讨审稿人喜欢。这些问题影响发表，未必帮助人把事情做成。

做事的人通常更关心：它有没有用，原来的方法哪里不行，换个环境还能不能工作，自己能不能接着做下去。
