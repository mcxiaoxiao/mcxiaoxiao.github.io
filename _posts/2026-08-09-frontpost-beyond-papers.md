...
这样一来，我们真正要想的也许不是“怎样让人每天看更多信息”，而是怎样把越来越多的算力，在科学与技术信息这个方向上，转化成更多人的理解、判断、协作和创造。不要把算力只转化成更多漂亮的摘要、更多没人读完的报告，而是转化成一条有用的线索、一个被发现的反例、一次更少弯路的判断，或者一个人终于开始做的实验。这可能也是 FrontPost 更大的使命，只是我们还远没有想清楚该怎么把它做好。
