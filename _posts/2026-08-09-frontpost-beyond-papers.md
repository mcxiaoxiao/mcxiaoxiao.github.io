...
这样一来，我们真正要想的也许不是“怎样让人每天看更多信息”，而是怎样把越来越多的算力，转化成更多人真正找得到、看得懂、用得上的前沿信息。不要把算力只转化成更多漂亮的摘要、更多没人读完的报告，而是让它帮人找到一条有用的线索、一个被忽略的反例，或者一个值得继续追下去的问题。这可能也是 FrontPost 更大的使命，只是我们还远没有想清楚该怎么把它做好。
